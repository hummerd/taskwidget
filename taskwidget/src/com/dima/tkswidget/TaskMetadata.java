...
public class TaskMetadata {
	...
	public static final EntityMetaInfo TASK_INFO = new EntityMetaInfo(
		...
		Uri.fromParts(ContentResolver.SCHEME_CONTENT, AUTHORITY + "/tasks", ""),
		Uri.fromParts(ContentResolver.SCHEME_CONTENT, AUTHORITY + "/task", ""),
		Uri.fromParts(ContentResolver.SCHEME_CONTENT, AUTHORITY + "/task", "/#"),
		1,
	...
	public static final EntityMetaInfo TASK_LIST_INFO = new EntityMetaInfo(
		...
		Uri.fromParts(ContentResolver.SCHEME_CONTENT, AUTHORITY + "/tasklists", ""),
		Uri.fromParts(ContentResolver.SCHEME_CONTENT, AUTHORITY + "/tasklist", ""),
		Uri.fromParts(ContentResolver.SCHEME_CONTENT, AUTHORITY + "/tasklist", "/#"),
		1,
