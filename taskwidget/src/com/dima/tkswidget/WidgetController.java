...
public class WidgetController {
  ...
  public WidgetController(@NonNull  Context context, @Nullable AppWidgetManager widgetManager) {
    m_context = context;
  ...
  protected void updateWidget(RemoteViews views, int widgetId) {
    ...
    if (listId == null) {
      views.setTextViewText(R.id.textViewList, m_context.getText(R.string.touch_to_configure_widget));
  ...
  protected void setupEvents(RemoteViews views, int widgetId) {
    try {
      ...
      views.setOnClickPendingIntent(R.id.headerClick, actionPendingIntent);

//            PendingIntent actionPendingIntent = setupEvent(widgetId, providerClass, TASKS_CLICK_ACTION);
//            views.setOnClickPendingIntent(R.id.tasksArea, actionPendingIntent);
  ...
  protected List<AccountWidgets> getGroupedAccounts(int[] widgetIds) {
    List<AccountWidgets> result = new ArrayList<>();
    ...
    for (int wId : widgetIds) {
      ...
      if (widgets == null) {
        ...
        widgets.widgetsIds = new ArrayList<>();
        result.add(widgets);
      }
